...
assume -name rfassumptions11 {__ILA_I_io_token == (m1.upstream.token_clk_i[0] ^ token_clk_i)}
assume -name issue_decode12 {(~ __START__) || (__ILA_BSG_UPSTREAM_decode_of_TOKEN_IN__)}
