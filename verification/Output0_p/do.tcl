...
assume -name issue_decode14 {(~ __START__) || (__ILA_BSG_UPSTREAM_OUT_decode_of_Output0_p__)}
...
assert -name variable_map_assert2 {(~ __IEND__) || ({m1.ch_1_oddr_phy.data_i_r[16:9], m1.ch_1_oddr_phy.data_i_r[7:0], 16'b0} + {m1.ch_0_oddr_phy.data_i_r[16:9], m1.ch_0_oddr_phy.data_i_r[7:0]} == __ILA_SO_data_temp)}
assert -name variable_map_assert3 {(~ __IEND__) || (m1.io_data_r_o[7:0] == __ILA_SO_io_data_out_ch0)}
assert -name variable_map_assert4 {(~ __IEND__) || (m1.io_data_r_o[15:8] == __ILA_SO_io_data_out_ch1)}
assert -name variable_map_assert5 {(~ __IEND__) || (m1.io_valid_r_o[0] == __ILA_SO_io_valid_out)}
