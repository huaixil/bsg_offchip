...
assume -name additional_mapping_control_assume10 {m1.token_clk_i[0] == token_clk_i && m1.token_clk_i[1] == token_clk_i}
assume -name rfassumptions11 {m1.core_data_i == data_i}
assume -name rfassumptions12 {m1.core_valid_i == valid_i}
assume -name rfassumptions13 {sent_counter - finish_counter <= 7'b1000000}
assume -name issue_decode14 {(~ __START__) || (__ILA_BSG_UPSTREAM_decode_of_TOKEN_IN__)}
