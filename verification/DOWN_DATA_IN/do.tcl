...
assume -name issue_decode13 {(~ __START__) || (__ILA_BSG_DOWNSTREAM_ch_decode_of_DOWN_DATA_IN__)}
assume -name issue_valid14 {(~ __START__) || (__ILA_BSG_DOWNSTREAM_ch_valid__)}
assert -name variable_map_assert0 {(~ __IEND__) || (XRAM_EQ_)}
assert -name variable_map_assert1 {(~ __IEND__) || (__m8__)}
assert -name variable_map_assert2 {(~ __IEND__) || (__m9__)}
assert -name variable_map_assert3 {(~ __IEND__) || (__m10__)}
assert -name variable_map_assert4 {(~ __IEND__) || (__m11__)}
